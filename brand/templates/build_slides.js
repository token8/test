...
const { tokens: t, H, B, C, M, LOGO, createDeck, txt, save } = require("./masters");

const pres = createDeck("Brand Slides Template v0.4");
...
save(pres, __dirname + "/brand-slides-template.pptx");
